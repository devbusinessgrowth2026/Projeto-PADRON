        ...
        <section id="projects" className="project-section-3 section-padding pb-0 fix bg-cover" style={{ backgroundImage: 'url("/img/testimonial/bg.jpg")' }}>
            <div className="container">
                <div className="section-title-area">
                    <SectionTitle>
                        <SectionTitle.SubTitle className="text-white">Últimos projetos</SectionTitle.SubTitle>
                        <SectionTitle.Title className="text-white">Projetos Realizados</SectionTitle.Title>
                    </SectionTitle>
